...
//     version 1.3.0
//     from Assets/OCSVehicleIO/Runtime/InputActions/Backhoe/BackhoeInput.inputactions
//
...
namespace OCS.VehicleIO
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                {
                    ""name"": ""LeftCrawlerStick"",
                    ""type"": ""PassThrough"",
                    ""id"": ""fbfd2443-2d2b-49b5-be39-758bf2a6a605"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""7b737ca9-15b9-4e0c-afd3-298efbe1fe01"",
                    ""path"": ""<Gamepad>/rightTrigger"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""LeftCrawlerStick"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
            ...
            m_Backhoe_LeftCrawlerStick = m_Backhoe.FindAction("LeftCrawlerStick", throwIfNotFound: true);
        ...
        private readonly InputAction m_Backhoe_LeftCrawlerStick;
        ...
        public struct BackhoeActions
        {
            ...
            public InputAction @LeftCrawlerStick => m_Wrapper.m_Backhoe_LeftCrawlerStick;
            ...
            public void SetCallbacks(IBackhoeActions instance)
            {
                ...
                {
                    @LeftCrawlerStick.started -= m_Wrapper.m_BackhoeActionsCallbackInterface.OnLeftCrawlerStick;
                    @LeftCrawlerStick.performed -= m_Wrapper.m_BackhoeActionsCallbackInterface.OnLeftCrawlerStick;
                    @LeftCrawlerStick.canceled -= m_Wrapper.m_BackhoeActionsCallbackInterface.OnLeftCrawlerStick;
                ...
                if (instance != null)
                {
                    @LeftCrawlerStick.started += instance.OnLeftCrawlerStick;
                    @LeftCrawlerStick.performed += instance.OnLeftCrawlerStick;
                    @LeftCrawlerStick.canceled += instance.OnLeftCrawlerStick;
        ...
        {
            void OnLeftCrawlerStick(InputAction.CallbackContext context);
